import { app, BrowserWindow, Menu, dialog, ipcMain, MenuItemConstructorOptions, MenuItem, SaveDialogOptions } from 'electron';
...
const createWindow = () => {
  ...
  ipcMain.on("save-file-value", (event, args) => {
      const options = {
          ...
          properties: [] as ("showHiddenFiles" | "createDirectory" | "treatPackageAsDirectory" | "dontAddToRecent" | "showOverwriteConfirmation")[],
